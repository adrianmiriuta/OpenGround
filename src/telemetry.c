...
static uint16_t telemetry_decoded_data_heading;
...
void telemetry_init(void) {
  ...
  telemetry_decoded_data_heading = 0;
...
static void telemetry_process_hub_packet(uint8_t id, uint16_t value) {
  ...
  case 0x14:
    telemetry_decoded_data_heading = value * 10;
    break;
  }
}
...
uint16_t telemetry_get_heading(void) {
  return telemetry_decoded_data_heading;
}
